...
public final class ItemCategory {
    // old
    public static final int DECORATION = GameEnums.getInt(GameEnums.getSingleton().getEnum("item_category", "decoration"));
    ...
    // new
    public static final int CONSTRUCTION = GameEnums.getInt(GameEnums.getSingleton().getEnum("item_category", "construction"));
    ...
    public static final int EQUIPMENT = GameEnums.getInt(GameEnums.getSingleton().getEnum("item_category", "equipment"));
    public static final int COMMAND_ONLY = GameEnums.getInt(GameEnums.getSingleton().getEnum("item_category", "command_only"));
