...
public class Explosion {
    ...
    public boolean explodeA() {
        if (what instanceof EntityExplosive) {
            ...
            if (block == BlockID.FLOWING_WATER || block == BlockID.STILL_WATER
                    || (block = level.getBlockIdAt(entity.getFloorX(), entity.getFloorY(), entity.getFloorZ())) == BlockID.FLOWING_WATER
    ...
    public boolean explodeB() {
        ...
        for (Block block : this.affectedBlocks) {
            ...
            this.level.setBlock(new Vector3(block.x, block.y, block.z), Block.get(BlockID.AIR));
            ...
            for (BlockFace side : BlockFace.values()) {
                ...
                if (!this.affectedBlocks.contains(sideBlock) && !updateBlocks.contains(index)) {
                    ...
                    Block layer1 = this.level.getBlock(sideBlock);
                    if (layer1.getId() != BlockID.AIR) {
